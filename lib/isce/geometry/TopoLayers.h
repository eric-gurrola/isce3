...
class isce::geometry::TopoLayers {
    ...
    public:
        ...
        void setRasters(isce::io::Raster & xRaster, isce::io::Raster & yRaster,
            ...
            _alphaRaster = &alphaRaster;
            _betaRaster = &betaRaster;
        }
        ...
        float alpha(size_t row, size_t col) const {
            return _alpha[row*_width + col];
        }

        float beta(size_t row, size_t col) const {
            return _beta[row*_width + col];
        }
        ...
        void writeData(size_t xidx, size_t yidx) {
            ...
            _alphaRaster->setBlock(_sim, xidx, yidx, _width, _length);
            _betaRaster->setBlock(_sim, xidx, yidx, _width, _length);
            if (_maskRaster) {
    ...
    private:
        ...
        isce::io::Raster * _alphaRaster;
        isce::io::Raster * _betaRaster;
